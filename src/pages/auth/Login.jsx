...
import { authAPI, healthCheck } from "../../services/api"; // API functions(login සහ backend check)
...
const Login = () => {
  ...
  useEffect(() => {
    // Call healthCheck function to verify backend status
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Creating Display error message
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm">
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold text-[#004A66] mb-2">
              Welcome Back! Cleanzy Mart.
            </h2>
            <p className="text-gray-500 text-base">
              Login to your Cleanzy Mart account.
            </p>
          </div>
